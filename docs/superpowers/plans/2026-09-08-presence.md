...
- **Bundle ID:** `com.rootless.presence`, fixo. Mudá-lo invalida a permissão de Acessibilidade já concedida.
...
- **Log:** `OSLog` com subsystem `com.rootless.presence`.
...
Expected: uma entrada para `com.rootless.presence`. O toggle deve permanecer ligado ao reabrir o menu.
